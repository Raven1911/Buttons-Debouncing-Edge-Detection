...
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports reset_n]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports noisy]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports debounced]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports p_edge]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports n_edge]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports any_edge]
