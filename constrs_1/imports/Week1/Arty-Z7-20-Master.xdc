...
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { noisy }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
## LEDs
# set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { debounced }]; #IO_L6N_T0_VREF_34 Sch=LED0
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { p_edge }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { n_edge }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { any_edge }]; #IO_L23P_T3_35 Sch=LED3

## Buttons
# set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { noisy }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { reset_n }]; #IO_L4N_T0_35 Sch=BTN1
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { debounced  }]; #IO_L5P_T0_34            Sch=CK_IO0
